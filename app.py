...
st.markdown('Niheon AniVision is an AI-powered easy-to-use app for identifying animals (dog, horse, elephant, butterfly, chicken, cat, cow) in any uploaded image. Explore the wonders of wildlife and discover new creatures with just a few clicks.')
